...
Connection con=cc.conexion();
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        TablaEstudiante.setBackground(new java.awt.Color(255, 255, 204));
        ...
        btnAsig.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "POO", "Computacion Digital", "EDO", "Calculo", " " }));
    ...
    try {
        ...
        pst.setString(3, btnApellido.getText()); // Corregido: utilizar btnApellido en lugar de btnNombre
        pst.setString(4, btnProm.getText());
        pst.setString(5, btnEstado.getItemAt(select2)); // Corregido: utilizar select2 para el estado
        pst.execute();
        
        // Agregar esta línea para actualizar la tabla después de agregar un nuevo registro
        mostrarDatos();
   ...
   // TODO add your handling code here:
    ...
    if (filaSeleccionada == -1) {
        ...
        String codigo = TablaEstudiante.getValueAt(filaSeleccionada, 0).toString(); // Obtener el valor del código
